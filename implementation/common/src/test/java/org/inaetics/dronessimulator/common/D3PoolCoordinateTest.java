...
public class D3PoolCoordinateTest {
    ...
    public void testUnnormalizedConstruction() {
        ...
        Assert.assertEquals("a1", 1.2 * Math.PI, neg_length.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", -0.4 * Math.PI, neg_length.getAngle2_x_z(),0.01);
        ...
        Assert.assertEquals("a1", 1.8 * Math.PI, neg_a1.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", 0.4 * Math.PI, neg_a1.getAngle2_x_z(),0.01);
        Assert.assertEquals("l", 5, neg_a1.getLength(),0.01);

        D3PolarCoordinate pos_a1 = new D3PolarCoordinate(2.20 * Math.PI, 0.4 * Math.PI, 5);
        Assert.assertEquals("a1", 0.2 * Math.PI, pos_a1.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", 0.4 * Math.PI, pos_a1.getAngle2_x_z(),0.01);
        Assert.assertEquals("l", 5, pos_a1.getLength(),0.01);

        D3PolarCoordinate neg_a2 = new D3PolarCoordinate(0.2 * Math.PI, -0.6 * Math.PI, 5);
        Assert.assertEquals("a1", 1.2 * Math.PI, neg_a2.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", -0.4 * Math.PI, neg_a2.getAngle2_x_z(),0.01);
        Assert.assertEquals("l", 5, neg_a2.getLength(),0.01);

        D3PolarCoordinate negger_a2 = new D3PolarCoordinate(0.2 * Math.PI, -1.2 * Math.PI, 5);
        Assert.assertEquals("a1", 1.2 * Math.PI, negger_a2.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", 0.2 * Math.PI, negger_a2.getAngle2_x_z(),0.01);
        ...
        Assert.assertEquals("a1", 0.2 * Math.PI, neggest_a2.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", 0.4 * Math.PI, neggest_a2.getAngle2_x_z(),0.01);
        ...
        Assert.assertEquals("a1", 1.6 * Math.PI, pos_a2.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", 0.4 * Math.PI, pos_a2.getAngle2_x_z(),0.01);
        Assert.assertEquals("l", 5, pos_a2.getLength(),0.01);

        D3PolarCoordinate posser_a2 = new D3PolarCoordinate(0.2 * Math.PI, 1.2 * Math.PI, 5);
        Assert.assertEquals("a1", 1.2 * Math.PI, posser_a2.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", -0.2 * Math.PI, posser_a2.getAngle2_x_z(),0.01);
        ...
        Assert.assertEquals("a1", 0.2 * Math.PI, possest_a2.getAngle1_x_y() ,0.01);
        Assert.assertEquals("a2", -0.4 * Math.PI, possest_a2.getAngle2_x_z(),0.01);
    ...
    public void testToVector() {
        ...
        Assert.assertEquals("a1", 0 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", 0.5 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", 0 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0.5 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", 1.5 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", 0.5 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0.25 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", 0.25 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", 0.75 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", 1.25 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", 0 * Math.PI ,p.getAngle2_x_z(), 0.01);
        ...
        Assert.assertEquals("a1", 0.25 * Math.PI ,p.getAngle1_x_y(), 0.01);
        Assert.assertEquals("a2", Math.atan(1/Math.sqrt(2)) ,p.getAngle2_x_z(), 0.01);
