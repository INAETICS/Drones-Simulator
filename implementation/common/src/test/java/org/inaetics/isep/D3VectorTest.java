...
public class D3VectorTest {
    ...
    public void testToPoolCoordinate() {
        ...
        // For zero,zero,zero
        p = v_zero_zero_zero.toPoolCoordinate();
        ...
        // For pos, pos, pos
        p = v_pos_pos_pos.toPoolCoordinate();
        Assert.assertEquals("a1", 0.25 * Math.PI ,p.getAngle1(), 0.01);
