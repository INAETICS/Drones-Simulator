package org.inaetics.dronessimulator.discovery.api.mocks;
...
public class MockDiscoverer implements Discoverer {
    ...
    @Getter
    private List<Instance> registeredInstances = new LinkedList<>();
    @Getter
    private List<Instance> unregisteredInstances = new LinkedList<>();
    ...
    public void register(Instance instance) throws DuplicateName, IOException {
        if (registeredInstances.contains(instance)) {
            throw new DuplicateName(instance.getName());
        }
        registeredInstances.add(instance);
        unregisteredInstances.remove(instance);
    }

    @Override
    public void unregister(Instance instance) throws IOException {
        unregisteredInstances.add(instance);
